...
try {
    ...
    // Calculate accuracy for pharmaceutical forecast
    if (isset($pharma_forecast) && !isset($pharma_forecast['error'])) {
        $pharma_data = $forecaster->getPharmaceuticalTrends(12);
    ...
    // Calculate accuracy for livestock forecast
    if (isset($livestock_forecast) && !isset($livestock_forecast['error'])) {
    ...
    // Calculate accuracy for poultry forecast
    if (isset($poultry_forecast) && !isset($poultry_forecast['error'])) {
    ...
    echo json_encode([
        ...
        'summary_metrics' => [
            ...
            'critical_alerts_count' => isset($insights['low_stock_alerts']) ? $insights['low_stock_alerts']['critical_count'] : 0,
            'total_data_points' => 0
        ],
