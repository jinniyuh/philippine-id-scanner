                    ...
                    <?php if ($view_mode === 'clients'): ?>
                        ...
                        <div class="col-md-3">
                            <div class="metric-card" role="button" data-bs-toggle="modal" data-bs-target="#noneClientsModal">
                                <div class="metric-title">Undisseminated Clients</div>
                                <div class="metric-value"><?php echo number_format($none_clients); ?></div>
                                <div class="metric-detail">Clients with No Disseminated Animals</div>
                            </div>
                        </div>
                    <?php else: ?>
                        <div class="col-md-4">
                        ...
                        <?php if ($clients && $clients->num_rows > 0): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php elseif ($hasDisseminated): ?>
                                        <span class="stats-sublabel status-pending">Pending</span>
                                    <?php else: ?>
                                        <span class="stats-sublabel status-none">None</span>
                                    <?php endif; ?>
                                </td>
                                <td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal fade" id="pendingClientsModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Clients with monthly photo submissions awaiting review.</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="table-responsive">
    ...
    <div class="modal fade" id="noneClientsModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Clients with no disseminated animals or photo submissions.</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div class="table-responsive">
              <table class="table table-striped">
                ...
                <?php if ($none_clients_list && $none_clients_list->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr><td colspan="3" class="text-center">No clients with none status</td></tr>
                <?php endif; ?>
                </tbody>
              </table>
            </div>
    ...
    <script>
        ...
        function filterUserTable() {
            ...
            tableRows.forEach(row => {
                ...
                if (username.includes(searchValue) || fullname.includes(searchValue) || status.includes(searchValue)) {
                    row.style.display = '';
                } else {
                    row.style.display = 'none';
                }
