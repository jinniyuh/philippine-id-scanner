...
function populateClients($conn) {
    ...
    $clients = [
        ['Sample User 1', '09123456789', 'Abuanan', 'Purok 1'],
        ['Sample User 2', '09234567890', 'Alianza', 'Purok 2'],
        ['Sample User 3', '09345678901', 'Atipuluan', 'Purok 3'],
        ['Sample User 4', '09456789012', 'Bacong-Montilla', 'Purok 4'],
        ['Sample User 5', '09567890123', 'Bagroy', 'Purok 5'],
        ['Sample User 6', '09678901234', 'Balingasag', 'Purok 6'],
        ['Sample User 7', '09789012345', 'Binubuhan', 'Purok 7'],
        ['Sample User 8', '09890123456', 'Busay', 'Purok 8'],
        ['Sample User 9', '09901234567', 'Calumangan', 'Purok 9'],
        ['Sample User 10', '09012345678', 'Caridad', 'Purok 10']
    ];
