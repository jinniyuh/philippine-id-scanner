                    ...
                    <form id="photoUploadForm" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="animal_id" id="upload_animal_id" required>
                                ...
                                $client_id = $_SESSION['client_id'];
                                $animal_query = "SELECT animal_id, species, animal_type FROM livestock_poultry WHERE client_id = ? ORDER BY created_at DESC, species";
                                ...
                                while ($animal = $animal_result->fetch_assoc()) {
                                    echo '<option value="' . $animal['animal_id'] . '">' . $animal['species'] . ' (' . $animal['animal_type'] . ')</option>';
                                }
                                ?>
                            </select>
                        </div>
