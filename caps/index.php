...
if (isset($_POST['register'])) {
    ...
    if (!$full_name || !$contact_number || !$address || !$username || !$password_raw) {
        ...
        // Validate Bago City residency from address
...
if (!$ok) {
    ...
    list($isValid, $validationMessage) = validateIDForBagoResidency($ocrText, $full_name);
...
<body>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="announcement-box">
                        <div class="announcement-content" id="homepage-announcement">
                            <div class="text-center py-4">
                                <i class="fas fa-spinner fa-spin fa-2x" style="color: #6c63ff;"></i>
  ...
  <!-- Load Announcement Dynamically -->
  <script>
    // Load announcement from database
    function loadHomepageAnnouncement() {
        fetch('get_announcement.php')
            .then(res => res.json())
            .then(data => {
                const container = document.getElementById('homepage-announcement');
                
                if (data.success && data.announcement) {
                    const ann = data.announcement;
                    
                    // Format reminders to include bullet points
                    let formattedReminders = ann.reminders || 'No reminders';
                    if (!formattedReminders.includes('<br>')) {
                        formattedReminders = formattedReminders.replace(/\n/g, '<br>');
                    }
                    ...
                    container.innerHTML = `
                        ...
                        <div class="announcement-event-title">${ann.title || 'No Title'}</div>
                        
                        <div class="announcement-detail">
                            <div class="announcement-label">Where</div>
                            <div class="announcement-text">${ann.location || 'Not specified'}</div>
                        </div>
                        
                        <div class="announcement-detail">
                            <div class="announcement-label">When</div>
                            <div class="announcement-text">${ann.event_date || 'Not specified'}</div>
                        </div>
                    ...
                    // Show default or empty message
                    container.innerHTML = `
                        <div class="text-center py-4">
                            <i class="fas fa-bullhorn fa-3x mb-3" style="color: #6c63ff; opacity: 0.3;"></i>
            ...
            .catch(err => {
                ...
                container.innerHTML = `
                    ...
                    <div class="announcement-event-title">Stay tuned for updates!</div>
                    <div class="announcement-cta">
                        <p class="announcement-cta-text">
                            Check back later for important announcements from Bago City Veterinary Office.
                        </p>
                    </div>
                `;
            });
