...
$stmt = $conn->prepare("SELECT *, COALESCE(password_changed_at, created_at) as password_changed_at FROM users WHERE user_id = ?");
...
<head>
    ...
    <title>Staff Profile - Bago City Veterinary Office</title>
                ...
                <div class="profile-section">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <img src="<?php echo isset($staff['profile_photo']) ? htmlspecialchars($staff['profile_photo']) : 'assets/images/default-profile.jpg'; ?>"
                                        alt="Profile Picture" class="profile-image">
                            <div class="ms-3 profile-info">
                                <h4><?php echo htmlspecialchars($staff['name'] ?? ''); ?></h4>
                                <span class="status-badge">Active Account</span>
                                <p class="registration-date">Registered: <?php echo date('F j, Y', strtotime($staff['created_at'])); ?></p>
                        ...
                        <h5>Personal Information</h5>
                            ...
                            <div class="info-display">
                                <div class="info-item">
                                    ...
                                    <span><?php echo htmlspecialchars($staff['username'] ?? 'Not provided'); ?></span>
                                </div>
                                <div class="info-item">
                                    <label>Address:</label>
                                    <span><?php echo htmlspecialchars($staff['address'] ?? 'Not provided'); ?></span>
                                </div>
                                <div class="info-item">
                                    <label>Contact Number:</label>
                                    <span><?php echo htmlspecialchars($staff['contact_number'] ?? 'Not provided'); ?></span>
                                </div>
                            </div>
                            </div>
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="info-display">
                                ...
                                <div class="info-item">
                                    ...
                                    <span><?php 
                                    $lastChanged = isset($staff['password_changed_at']) ? $staff['password_changed_at'] : $staff['created_at'];
                            ...
                            <select class="form-select" name="address" id="address" required>
                                ...
                                <?php foreach ($barangays as $barangay): ?>
                                    <option value="<?php echo htmlspecialchars($barangay); ?>" 
                                            <?php echo ($staff['address'] ?? '') === $barangay ? 'selected' : ''; ?>>
...
document.getElementById('profilePicture').addEventListener('change', function() {
    ...
    fetch('staff_update_profile_picture.php', {
        method: 'POST',
        body: formData
    })
    ...
    fetch('staff_update_personal_info.php', {
        method: 'POST',
                headers: {
    ...
    fetch('staff_update_password.php', {
        method: 'POST',
        body: formData
    })
            .then(response => response.json())
