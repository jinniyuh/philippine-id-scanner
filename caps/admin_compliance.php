...
$non_compliant_query = "SELECT COUNT(*) AS non_compliant FROM compliance WHERE compliance_status = 'Non-Compliant'";
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="compliance_status" name="compliance_status" required>
                                ...
                                <option value="Complied">Complied</option>
                                <option value="Pending">Pending</option>
                                <option value="Non-Compliant">Non-Compliant (Animal Loss)</option>
                            </select>
                        </div>
