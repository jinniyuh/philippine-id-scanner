...
<title>Staff Reports - Bago City Veterinary Office</title>
...
.staff-header h2 { margin: 0; font-weight: bold; color: #000000; pointer-events: none; }
.staff-header * { pointer-events: auto; }

/* Print Reports Button Group */
.staff-header .btn-group {
    position: relative !important;
    z-index: 1050 !important;
    pointer-events: auto !important;
}

.staff-header .btn-group .btn {
...
.staff-header .btn-group .btn:hover {
    background-color: #5a52d5 !important;
    border-color: #5a52d5 !important;
}

.staff-header .btn-group .dropdown-menu {
    z-index: 1060 !important;
    pointer-events: auto !important;
    display: none !important;
}

.staff-header .btn-group .dropdown-menu.show {
...
/* Loading Spinner */
.loading-overlay { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255,255,255,0.93); display: none; align-items: center; justify-content: center; z-index: 1030; pointer-events: none; }
.loading-overlay.show { pointer-events: auto; }
            ...
            <div class="staff-header">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li>
                            <a class="dropdown-item" href="staff_client_uploads.php">
                                <i class="fas fa-images me-2"></i> Client Uploaded Photos
                            </a>
                        </li>
                    </ul>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Ensure button is clickable - force z-index and pointer events
    const printButton = document.querySelector('.staff-header .btn-group .btn');
    if (printButton) {
        printButton.style.zIndex = '9999';
        printButton.style.pointerEvents = 'auto';
        printButton.style.position = 'relative';
        console.log('Print Reports button found and configured:', printButton);
        
        // Add click listener as backup
        printButton.addEventListener('click', function(e) {
            console.log('Print Reports button clicked!', e);
            e.stopPropagation();
            e.preventDefault();
            
            // Manually toggle the dropdown
            const dropdown = bootstrap.Dropdown.getOrCreateInstance(printButton);
            dropdown.toggle();
            
            // Force show dropdown if it doesn't open
            setTimeout(() => {
                const dropdownMenu = printButton.nextElementSibling;
        ...
        console.error('Print Reports button NOT found!');
    }
