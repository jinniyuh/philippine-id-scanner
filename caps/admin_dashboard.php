...
<head>
    ...
    <style>
        ...
        .custom-notification-info {
            background: linear-gradient(135deg, #17a2b8, #6c63ff);
            color: white;
            ...
            <div class="main-content">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <a href="admin_ml_insights.php" class="btn btn-sm btn-outline-primary ms-auto">
                ...
                <div class="row mt-4">
                    <div class="col-12 mb-4">
                        <div class="card h-100">
                            <div class="card-header d-flex align-items-center" style="background-color: #6c63ff; color: white;">
                                <i class="fas fa-bullhorn me-2"></i> Announcement
                                <button class="btn btn-sm btn-light ms-auto" data-bs-toggle="modal" data-bs-target="#announcementModal" id="editAnnouncementBtn">
                                    <i class="fas fa-edit"></i> Edit / Add Announcement
                                </button>
                            </div>
                            <div class="card-body" id="announcement-preview">
                                <div class="loading-message">
                                    <i class="fas fa-spinner fa-spin me-2"></i>Loading announcement...
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <div class="modal-header" style="background-color: #6c63ff; color: white;">
                    <h5 class="modal-title" id="announcementModalLabel">
                        <i class="fas fa-bullhorn me-2"></i>Edit / Add Announcement
                    </h5>
                ...
                <form id="announcementForm">
                    <div class="modal-body">
                        <div class="alert alert-info">
                            ...
                            This announcement will be displayed on both the admin dashboard and the homepage.
                        </div>
                        
                        <div class="mb-3">
                            <label for="announcement_title" class="form-label">
                            ...
                            <input type="text" class="form-control" id="announcement_title" name="title" required 
                                   placeholder="e.g., Mass Anti-Rabies Vaccination">
                        </div>
                        
                        <div class="mb-3">
                            <label for="announcement_location" class="form-label">
                                <i class="fas fa-map-marker-alt me-1"></i>Location / Where <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" id="announcement_location" name="location" required 
                                   placeholder="e.g., Barangay Dulao, Bago City">
                        </div>
                        
                        <div class="mb-3">
                            <label for="announcement_date" class="form-label">
                                <i class="fas fa-calendar-alt me-1"></i>Event Date / When <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" id="announcement_date" name="event_date" required 
                                   placeholder="e.g., September 8-24, 2025">
                        </div>
                        
                        <div class="mb-3">
                            <label for="announcement_reminders" class="form-label">
                                <i class="fas fa-exclamation-circle me-1"></i>Important Reminders <span class="text-danger">*</span>
                            </label>
                            <textarea class="form-control" id="announcement_reminders" name="reminders" rows="5" required
                                      placeholder="Enter reminders (one per line)&#10;• 3 months old and above&#10;• Pets must be healthy&#10;• Owner must hold their pets during vaccination"></textarea>
                            <small class="form-text text-muted">Tip: Start each line with a bullet point (•) for better formatting</small>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" style="background-color: #6c63ff; border-color: #6c63ff;">
                ...
                fetch('get_announcement.php')
                        ...
                        if (data.success && data.announcement) {
                            ...
                            container.innerHTML = `
                                <div class="announcement-preview-box">
                                    <div class="d-flex align-items-center mb-3">
                                        <img src="bagocity.png" alt="Bago City Logo" style="width: 50px; height: 50px; border-radius: 50%; margin-right: 10px;">
                                        <img src="bcvo.png" alt="Veterinary Office Logo" style="width: 50px; height: 50px; border-radius: 50%; margin-right: 10px;">
                                        <h5 class="mb-0" style="color: #6c63ff;"><i class="fas fa-bullhorn me-2"></i>${ann.title || 'No Title'}</h5>
                                    </div>
                                    <div class="announcement-detail-item mb-2">
                                        <strong style="color: #6c63ff;"><i class="fas fa-map-marker-alt me-2"></i>Where:</strong> ${ann.location || 'Not specified'}
                                    </div>
                                    <div class="announcement-detail-item mb-3">
                                        <strong style="color: #6c63ff;"><i class="fas fa-calendar-alt me-2"></i>When:</strong> ${ann.event_date || 'Not specified'}
                                    </div>
                                    <div class="announcement-reminders" style="background-color: rgba(108, 99, 255, 0.1); padding: 15px; border-radius: 8px; border-left: 4px solid #6c63ff;">
                                        <strong style="color: #6c63ff;"><i class="fas fa-exclamation-circle me-2"></i>Important Reminders:</strong><br>
                                        ${ann.reminders ? ann.reminders.replace(/\n/g, '<br>') : 'No reminders'}
                                    </div>
                                    <small class="text-muted mt-3 d-block"><i class="far fa-clock me-1"></i>Last updated: ${ann.updated_at || 'Unknown'}</small>
                                </div>
                            `;
                            
                            // Populate form fields
                            document.getElementById('announcement_title').value = ann.title || '';
                            document.getElementById('announcement_location').value = ann.location || '';
                            document.getElementById('announcement_date').value = ann.event_date || '';
                            document.getElementById('announcement_reminders').value = ann.reminders || '';
                        } else {
                            container.innerHTML = `
                                <div class="text-center text-muted py-4">
                                    <i class="fas fa-bullhorn fa-3x mb-3" style="opacity: 0.3;"></i>
                                    <p>No announcement available.</p>
                                    <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#announcementModal" style="background-color: #6c63ff; border-color: #6c63ff;">
                    ...
                    .catch(err => {
                        ...
                        document.getElementById('announcement-preview').innerHTML = 
                            '<div class="error-message"><i class="fas fa-exclamation-triangle me-2"></i>Error loading announcement</div>';
                    });
            }
            ...
            document.getElementById('announcementForm').addEventListener('submit', function(e) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        showNotification('❌ Error: ' + (data.error || 'Failed to save announcement'), 'error');
                    }
                })
                .catch(err => {
