...
<body>
                ...
                <div class="modal-header">
                    ...
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                     ...
                     <div class="text-center mb-3">
                         <img id="modalUploadImage" src="" alt="Upload Image" class="img-fluid rounded" style="max-height: 400px; max-width: 100%; object-fit: contain;" onerror="this.src='data:image/svg+xml;base64,'; this.onerror=null;">
                     </div>
                     ...
                     <div id="rejectionReasonSection" class="mt-3" style="display: none;">
                         <div class="alert alert-warning">
                             ...
                             <p id="modalRejectionReason" class="mb-0"></p>
                         </div>
                     </div>
                 </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success" id="approveBtn" style="display: none;" onclick="approvePhoto()">
                        <i class="fas fa-check"></i> Approve
                    </button>
                    <button type="button" class="btn btn-danger" id="rejectBtn" style="display: none;" onclick="rejectPhoto()">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (avatarContainer) {
                avatarContainer.addEventListener('click', function(e) {
                    e.preventDefault();
                    e.stopPropagation();
                    if (avatarButton) avatarButton.click();
                });
            }
        ...
        // Function removed - staff is view-only
            ...
            photos.forEach(photo => {
                ...
                html += `
                    <div class="client-photo-item" onclick="showPhotoDetails(${JSON.stringify(photo).replace(/"/g, '&quot;')})" style="cursor: pointer;">
                        ...
                        <img src="${photo.photo_path}" alt="Animal Photo" onerror="this.src='data:image/svg+xml;base64,'; this.onerror=null;">
                        <div class="info">
        ...
        // Approve photo function
        function approvePhoto() {
            if (!window.currentUploadId) {
                alert('No photo selected for approval');
                return;
            }

            const formData = new FormData();
            formData.append('photo_id', window.currentUploadId);
            ...
            .then(data => {
                if (data.success) {
                    ...
                    const modal = bootstrap.Modal.getInstance(document.getElementById('uploadReviewModal'));
                    modal.hide();
                    location.reload();
                } else {
        ...
        // Reject photo function
        function rejectPhoto() {
            if (!window.currentUploadId) {
                alert('No photo selected for rejection');
                return;
            }
