...
<head>
    ...
    <title>Live Website Debug - Public Access</title>
    <style>
...
echo "<h1>🔍 Live Website Debug - Public Access</h1>";
...
echo "<ol>";
echo "<li>Log into your admin panel on the live website</li>";
echo "<li>Go to: <a href='install_live_database.php'>install_live_database.php</a></li>";
...
echo "<p><strong>Security Note:</strong> Delete this debug file after checking!</p>";
