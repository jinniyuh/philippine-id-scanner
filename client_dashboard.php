...
<head>
    ...
    <style>
        ...
        /* Remove backdrop when modal is open */
        body.modal-open {
        ...
        /* Apply blue background to modal header only */
        .modal-header {
        ...
        /* Remove table header icons and keep table headers white */
        .modal .table th i {
            display: none !important;
        }
        
        /* Keep table headers white background */
...
<body>
    ...
    <script>
        ...
        // Remove any backdrop elements that might be created
        document.addEventListener('DOMContentLoaded', function() {
            // Remove any existing backdrop elements
            const backdrops = document.querySelectorAll('.modal-backdrop');
            backdrops.forEach(backdrop => backdrop.remove());
            
            // Monitor for dynamically created backdrops and remove them
