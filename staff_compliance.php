...
// Get compliance statistics - ALL COMPLIANCE RECORDS
...
$compliant_query = "SELECT COUNT(*) AS compliant 
                    FROM compliance comp
                    INNER JOIN clients cl ON comp.client_id = cl.client_id
...
$non_compliant_query = "SELECT COUNT(*) AS non_compliant 
                        FROM compliance comp
                        INNER JOIN clients cl ON comp.client_id = cl.client_id
...
$pending_reviews_query = "SELECT COUNT(*) AS pending 
                         FROM compliance comp
                         INNER JOIN clients cl ON comp.client_id = cl.client_id
...
// Get compliance data for table - ALL COMPLIANCE RECORDS
