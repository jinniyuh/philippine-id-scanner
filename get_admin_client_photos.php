...
try {
    // Fetch all photos for the specified client with animal and status information
    $query = "
        SELECT 
            ap.photo_id,
            ap.photo_path,
        ...
        INNER JOIN clients c ON lp.client_id = c.client_id
        WHERE lp.client_id = ?
    ...
    error_log('Error in get_admin_client_photos.php: ' . $e->getMessage());
    echo json_encode([
        'success' => false,
